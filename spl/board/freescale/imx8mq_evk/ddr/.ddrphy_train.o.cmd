cmd_spl/board/freescale/imx8mq_evk/ddr/ddrphy_train.o := aarch64-poky-linux-gcc -Wp,-MD,spl/board/freescale/imx8mq_evk/ddr/.ddrphy_train.o.d  -nostdinc -isystem /home/poky/2.4/sysroots/x86_64-pokysdk-linux/usr/lib/aarch64-poky-linux/gcc/aarch64-poky-linux/7.3.0/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -I. -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time --sysroot=/home/poky/2.4/sysroots/aarch64-poky-linux -ffunction-sections -fdata-sections -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -mgeneral-regs-only -D__LINUX_ARM_ARCH__=8    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(ddrphy_train)"  -D"KBUILD_MODNAME=KBUILD_STR(ddrphy_train)" -c -o spl/board/freescale/imx8mq_evk/ddr/ddrphy_train.o board/freescale/imx8mq_evk/ddr/ddrphy_train.c

source_spl/board/freescale/imx8mq_evk/ddr/ddrphy_train.o := board/freescale/imx8mq_evk/ddr/ddrphy_train.c

deps_spl/board/freescale/imx8mq_evk/ddr/ddrphy_train.o := \
  include/common.h \
  ...
  arch/arm/include/asm/arch/ddr_memory_map.h \
  board/freescale/imx8mq_evk/ddr/ddr.h \
  board/freescale/imx8mq_evk/ddr/lpddr4_dvfs.h \

spl/board/freescale/imx8mq_evk/ddr/ddrphy_train.o: $(deps_spl/board/freescale/imx8mq_evk/ddr/ddrphy_train.o)
