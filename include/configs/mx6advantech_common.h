	...
	"netboot=echo Booting from net ...; " \
		...
		"findfdt="\
			"if test $fdt_file = undefined; then " \
				"if test $board_name =" ADV_BOARD_NAME "&& test $board_rev = MX6QP; then " \
					"setenv fdt_file imx6qp-"ADV_DEFAULT_FDT_NAME".dtb; fi; " \
				"if test $board_name =" ADV_BOARD_NAME "&& test $board_rev = MX6Q; then " \
					"setenv fdt_file imx6q-"ADV_DEFAULT_FDT_NAME".dtb; fi; " \
				"if test $board_name =" ADV_BOARD_NAME "&& test $board_rev = MX6DL; then " \
					"setenv fdt_file imx6dl-"ADV_DEFAULT_FDT_NAME".dtb; fi; " \
				"if test $fdt_file = undefined; then " \
