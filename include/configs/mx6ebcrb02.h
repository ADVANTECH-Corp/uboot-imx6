...
#if defined(CONFIG_TARGET_MX6EBCRB02A1_512M) || defined(CONFIG_TARGET_MX6EBCRB02A2_512M)
#define PHYS_SDRAM_SIZE         (512u * 1024 * 1024)
#elif defined(CONFIG_TARGET_MX6EBCRB02A1_1G) || defined(CONFIG_TARGET_MX6EBCRB02A2_1G)
#define PHYS_SDRAM_SIZE         (1u * 1024 * 1024 * 1024)
#elif defined(CONFIG_TARGET_MX6EBCRB02A1_2G) || defined(CONFIG_TARGET_MX6EBCRB02A2_2G)
#define PHYS_SDRAM_SIZE         (2u * 1024 * 1024 * 1024)
#endif

#if defined(CONFIG_TARGET_MX6EBCRB02A1_1G) || defined(CONFIG_TARGET_MX6EBCRB02A1_2G)
#if defined(CONFIG_MX6QP)
#define CONFIG_DEFAULT_FDT_FILE	"imx6qp-ebcrb02-a1.dtb"
#elif defined(CONFIG_MX6Q)
#define CONFIG_DEFAULT_FDT_FILE	"imx6q-ebcrb02-a1.dtb"
#elif defined(CONFIG_MX6DL)
#define CONFIG_DEFAULT_FDT_FILE	"imx6dl-ebcrb02-a1.dtb"
#elif defined(CONFIG_MX6SOLO)
#define CONFIG_DEFAULT_FDT_FILE	"imx6dl-ebcrb02-a1.dtb"
#endif
#elif defined(CONFIG_TARGET_MX6EBCRB02A2_1G)
#if defined(CONFIG_MX6QP)
#define CONFIG_DEFAULT_FDT_FILE "imx6qp-ebcrb02-a2.dtb"
#elif defined(CONFIG_MX6Q)
#define CONFIG_DEFAULT_FDT_FILE "imx6q-ebcrb02-a2.dtb"
#elif defined(CONFIG_MX6DL)
#define CONFIG_DEFAULT_FDT_FILE "imx6dl-ebcrb02-a2.dtb"
#elif defined(CONFIG_MX6SOLO)
#define CONFIG_DEFAULT_FDT_FILE "imx6dl-ebcrb02-a2.dtb"
#endif
#endif
